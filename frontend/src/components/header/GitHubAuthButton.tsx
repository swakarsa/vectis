    ...
    <>
      ...
      {modalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
          <div className="bg-[#0e0f13] border border-white/15 rounded-[6px] w-full max-w-md p-5 shadow-2xl space-y-4">
            {/* Header */}
            ...
            <div className="space-y-2 pt-1">
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="px-3 py-1.5 bg-white text-black hover:bg-zinc-200 text-xs font-medium rounded-[4px] transition-colors disabled:opacity-50 cursor-pointer"
                >
